...
public class PesquisarCliente extends javax.swing.JFrame
{
    ...
    /**
     * Creates new form Pesquisar_Cliente
     */
    public PesquisarCliente(java.awt.Frame parent, boolean modal, GerenciadorCIH ger)
    {
    ...
    {//GEN-HEADEREND:event_btnPesquisarActionPerformed
        try
        {
            gerCCI.getGerCDP().pesquisarCliente(tableResultado, txtPesquisa.getText());
    ...
    {//GEN-HEADEREND:event_tableResultadoMouseClicked
        ...
        try
        {
            cliSelecionado = (Cliente) tableResultado.getValueAt(linha, 0);
        ...
        gerCCI.carregarAlterarCliente(cliSelecionado);
