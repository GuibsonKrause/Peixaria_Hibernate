 ...
 * @author gkrause
 */
public class PesquisarPeixe extends javax.swing.JFrame
{
    ...
    /**
     * Creates new form Pesquisar_Peixe
     */
    public PesquisarPeixe(java.awt.Frame parent, boolean modal, GerenciadorCIH ger)
    {
    ...
    public Peixe getPeixeSelecionado()
    {
    ...
    private void initComponents()
    {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Pesquisar Peixe"));
    ...
    {//GEN-HEADEREND:event_btnPesquisarActionPerformed
        try
        {
            gerCCI.getGerCDP().pesquisarPeixe(tableResultado, txtPesquisa.getText());
    ...
    {//GEN-HEADEREND:event_tableResultadoMouseClicked
        ...
        try
        {
            peixeSelecionado = (Peixe) tableResultado.getValueAt(linha, 0);
        ...
        gerCCI.carregarAlterarPeixe(peixeSelecionado);
